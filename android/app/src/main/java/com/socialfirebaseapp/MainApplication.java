package com.socialfirebaseapp;

import com.socialfirebaseapp.generated.BasePackageList;
  ...
  private static void initializeFlipper(Context context, ReactInstanceManager reactInstanceManager) {
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.socialfirebaseapp.ReactNativeFlipper");
